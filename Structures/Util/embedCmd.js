...
const embeds = {
  ...
  jsonEmbed: new EmbedBuilder()
    .setColor("F4D58D")
    .setTitle(`Selecting JSON`)
    .setDescription(`**Select:** \`from the dropdown menu\``),
};
...
module.exports.buttons = function (client, interaction, collector = null, type = null) {
    ...
    if (btnInt.component.customId === "cancel") {
      ...
      interaction.message
        .edit({
          ...
          components: rows,
        }) // if interaction has been replied to delete it
        .then(() => {
